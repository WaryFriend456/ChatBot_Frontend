  ...
  return (
    <>
      <div className={`flex h-screen items-center justify-center ${darkMode ? 'dark' : ''}`}>
          ...
          <div className="flex justify-center">
            <Card className="w-full dark:bg-gray-800">
              <CardHeader color="blue" contentPosition="none">
                <h2 className="text-white text-lg font-bold p-4 mb-0">Sessions</h2>
              </CardHeader>
              <CardBody className="overflow-y-auto" style={{ maxHeight: 'calc(100vh - 240px)' }}>
        ...
        <div className="w-full sm:w-11/12 md:w-5/6 lg:w-2/4 xl:w-2/3">
          <Card className="dark:bg-gray-800">
            <CardHeader color="blue" contentPosition="none">
              <div className="flex justify-between items-center">
                <h2 className="text-white text-lg font-bold p-4 mb-0">Chatbot</h2>
                <Button
                  color="blue"
                  buttonType="filled"
